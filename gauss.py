...
###################################################################
def randxy(xrang = [0,1],yrang = [0,1] ):
...
###################################################################
def multixy(n, xr = [0,1], yr = [0,1] ):

    result = [randxy( xrang = xr,yrang = yr ) for i in range(n)]
...
###############################################################
# returns a frame with a random intensity
#
...
#
###################################################################
def gframe(center,sig,dim,norm=False):
...
#
###################################################################
def multigf(centers,sig,dim,norm=False):
    
    result = []
    for center in centers:
        result.append(gframe(center,sig,dim,norm=norm))
    return np.array(result)
